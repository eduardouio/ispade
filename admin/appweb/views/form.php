...
<body>
	...
	<div class="hero-unit" style="margin-top:40px">
		...
		<form action="<?php print base_url() . 'index.php/'. $form['controller']; ?>/edit" method="post" enctype="multipart/form-data">			
		...
		<textarea class="textarea" placeholder="Ingrese un Texto ..." style="width: 1000px; height: 400px">
