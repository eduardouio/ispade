...
-- contiene entidades que representan al CMS, se usará el servidor de liposerve.com
...
-- --------------------------------------------------------------------------------
  ...
  CREATE SCHEMA IF NOT EXISTS `liposerv_ispade` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
  USE `liposerv_ispade` ;